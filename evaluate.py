...
class VqaMedEvaluator:
    ...
    def compute_accuracy(self, predictions):
        ...
        for image_key in candidate_pairs:
            ...
            # Calculate accuracy score for the current caption
            try:
                ...
                # Calculate the accuracy score
                    ...
                    if gt_words == candidate_words:
                        accuracy_ = 1
                    else:
                        accuracy_ = 0
            # Handle problematic cases where accuracy score calculation is impossible
            except ZeroDivisionError:
                pass
                #raise Exception('Problem with {} {}', gt_words, candidate_words)

            # Increase calculated score
            current_score += accuracy_
